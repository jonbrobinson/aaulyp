                            ...
                            <article class="entry-post">
                                <header class="entry-header">
                                    <h2 class="entry-title">
                                        <a href="{{ url("/events/fb/$pastEvent->id".str_limit($event->platform, 2, "")) }}">{{ $pastEvent->title->text }}</a>
                                    </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <figure class="featured-image">
                                                <a href="{{ url("/events/fb/$pastEvent->id".str_limit($event->platform, 2, "")) }}">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="excerpt">
                                                ...
                                                @endif
                                                <p class="read-more">
                                                    <a href="{{ url("/events/fb/$pastEvent->id".str_limit($event->platform, 2, "")) }}" class="btn btn-primary">Read More <i class="fa fa-long-arrow-right"></i></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    @else
                        ...
                        @foreach($events as $event)
                            <article class="entry-post">
                                <header class="entry-header">
                                    <h2 class="entry-title">
                                        <a href="{{ url("/events/fb/$event->id".str_limit($event->platform, 2, "")) }}">{{ $event->title->text }}</a>
                                    </h2>
                                    <div class="meta-line clearfix">
                                        <div class="meta-author-category pull-left">
                                            <span class="post-author"><a href="#">Austin Area Urban League Young Professionals</a></span>
                                ...
                                <div class="entry-content clearfix">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <figure class="featured-image">
                                                <a href="{{ url("/events/fb/$event->id".str_limit($event->platform, 2, "")) }}">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="excerpt">
                                                ...
                                                @endif
                                                <p class="read-more">
                                                    <a href="{{ url("/events/fb/$event->id".str_limit($event->platform, 2, "")) }}" class="btn btn-primary">Read More <i class="fa fa-long-arrow-right"></i></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
