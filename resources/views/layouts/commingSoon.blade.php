...
<head>
    ...
    <meta name="description" content="Austin Area Urban League">
...
{{--        @yield('content')--}}
        <div class="row">
            ...
            <h1 class="text-center"><a href="/ypweekend2016" class="aaulyp-red">Click Here For YP Weekend Details</a></h1>
            <br>
