jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2016, 6, 8)}); // enter event day
...
$(window).load(function(){
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(lat, long) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Austin Area Urban League</b><br/>8011A Cameron Rd<br/> Austin, TX 78754"  //add your address
    });
